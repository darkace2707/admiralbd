...
public class ExcelParserTest {
    ...
    public void readFromExcel() throws IOException, ExcelNotStructuredException {
        ...
        Departure departureOne = Departure.builder()
                ...
                .arrivalDate((new GregorianCalendar(2020, 0, 6)).getTime())
                .lendingDate((new GregorianCalendar(2020, 0, 6)).getTime())
        ...
        Departure departureTwo = Departure.builder()
                ...
                .arrivalDate((new GregorianCalendar(2020, 0, 8)).getTime())
                .lendingDate((new GregorianCalendar(2020, 0, 9)).getTime())
        ...
        Departure departureThree = Departure.builder()
                ...
                .arrivalDate((new GregorianCalendar(2020, 0, 7)).getTime())
                .lendingDate((new GregorianCalendar(2020, 0, 7)).getTime())
