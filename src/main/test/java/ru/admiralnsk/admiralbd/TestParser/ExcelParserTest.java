...
public class ExcelParserTest {
    ...
    @Test
    public void excelFileStructureTest() throws IOException {
        ExcelParser excelParser1 = new ExcelParser(new DepartureFieldsMapper());
        MultipartFile file = new MockMultipartFile("TestExcel1.xlsx", new FileInputStream("src/main/test/resources/TestExcel1.xlsx"));

        Throwable thrown = assertThrows(ExcelNotStructuredException.class, () -> excelParser1.readFromExcel(file));
